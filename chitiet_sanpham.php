...
$sql_count = $sql = "SELECT count(*)  as total
        ...
        INNER JOIN tbl_product ON tbl_product.product_id = tbl_product_details.product_id
        AND tbl_brand.brand_name LIKE '%$brand_name%'
        AND tbl_cartegory.cartegory_name  LIKE '%$cartegory_name%' 
        AND tbl_product.product_name LIKE '%$product_name%'";
            ...
            <div class="cartegory-right-bottom row">
                <div class="cartegory-right-bottom-items">
                    ...
                    if ($current_page > 1 && $total_page > 1) {
                        echo '<a  class="pagination-item__link"  href="chitiet_sanpham.php?cartegory_name=' . ($cartegory_name) . '&brand_name=' . ($brand_name) . '&product_name=' . ($product_name) . '&page=' . ($current_page - 1) . '"> Prev</a> | ';
                    }
                    ?>
                    </li>
                    ...
                    for ($i = 1; $i <= $total_page; $i++) {
                        ...
                        if ($i == $current_page) {
                            ...
                            echo '<a   class="pagination-item__link" href="chitiet_sanpham.php?cartegory_name=' . ($cartegory_name) . '&brand_name=' . ($brand_name) . '&product_name=' . ($product_name) . '&page=' . $i . '">' . $i . '</a> | ';
                    ...
                    if ($current_page < $total_page && $total_page > 1) {
                        echo '<a  class="pagination-item__link"  href="chitiet_sanpham.php?cartegory_name=' . ($cartegory_name) . '&brand_name=' . ($brand_name) . '&product_name=' . ($product_name) . '&page=' . ($current_page + 1) . '"> Next</a>  ';
                    }
                    ?>
                </div>
