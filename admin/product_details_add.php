...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    $sql = "INSERT INTO tbl_product_details(
                    ...
                    product_details_img)
                    VALUES ('$product_details_name' , '$cartegory_id ' , '$brand_id ' ,'$product_id' , '$product_details_price' , 
                            '$product_details_desc' , '$product_details_img' )";
...
<div class="admin-content-right">
    <div class="admin-content-right-product_add">
        ...
        <form action="" method="Post" enctype="multipart/form-data">
            ...
            <textarea name="product_details_desc" id="editor1" cols="30" rows="10"></textarea>
